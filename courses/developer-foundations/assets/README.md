# Developer Foundations — Asset Library
...
| Partner kickoff kit | Doc + checklist | TODO | this folder |
| Build-clinic facilitation guide | Doc | TODO | this folder |
| Reviewer training pack | Doc + recordings | TODO | this folder |
...
- Umbrella framework asset library: [`../../../README.md` Part VI](../../../README.md#part-vi--infrastructure--assets) — the cross-course view including planned assets across all courses.
