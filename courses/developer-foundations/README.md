...
Each Build ships with five files:

- `README.md` — at-a-glance + start-here pointers
- `lesson.md` — concept + API + value (read this first)
- `walkthrough.md` — the vibe-coded exercise (1–3 hours of work)
- `quiz.md` — 5–7 multiple-choice + 1 short-answer (pass = 5/7 + credible SA)
...
|---|---|---|---|---|---|
| **0** | [Hello ARAG](builds/build-0-hello-arag/) | Provision a KB, make first calls, set up vibe-coding | 2–3 hrs | Tier 1 | 12 min |
| **1** | [The Five Primitives](builds/build-1-five-primitives/) | Tour of `/find`, `/ask`, `/ask`+schema, `/graph`, `/resource` | 2 hrs | Tier 1 | 15 min |
| **2** | [Drop-in Widgets](builds/build-2-drop-in-widgets/) | Branded `<nuclia-search-bar>`, `<nuclia-chat>` on a real site | 1.5 hrs | Tier 1 | 8 min |
