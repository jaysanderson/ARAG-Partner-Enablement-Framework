...
[Build 7 — Smart Filters & Labelsets](../build-7-smart-filters/) — the Labeller agent in action. You'll design a labelset, populate it via the agent you just enabled, and wire filter chips into a search UI.

After that, [Build 8 — Knowledge Graph 101](../build-8-knowledge-graph/) is the Graph agent in action.
