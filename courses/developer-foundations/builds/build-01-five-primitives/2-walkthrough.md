...
> Estimated time: 2–3 hours focused. Complete Build 0 and read the [lesson](1-lesson.md) first.
>
...
Then take the [Build 1 quiz](3-quiz.md). Pass → start [Build 2](../build-02-drop-in-widgets/).
...
[Build 2 — Drop-in Widgets](../build-02-drop-in-widgets/) — the fastest "we have a chatbot" demo. No backend, no Node, no API keys in code. Embed-and-go in 30 minutes.
