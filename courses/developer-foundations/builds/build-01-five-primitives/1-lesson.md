...
[Build 2 — Drop-in Widgets](../build-02-drop-in-widgets/) — the fastest path from "I just provisioned a KB" to "we have a working chatbot live on a real URL." 30-minute build, no backend.
