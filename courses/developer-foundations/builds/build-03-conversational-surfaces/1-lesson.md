...
[Build 4 — Multilingual & Voice Switching](../build-04-multilingual-and-voice/) — extend today's chat with language switching, persona scoping, and resource scoping. All implemented via query prefixes. The cheapest, highest-leverage extensions to a Tier 2 chat.
