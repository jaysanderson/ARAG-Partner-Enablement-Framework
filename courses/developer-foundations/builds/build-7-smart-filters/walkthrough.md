...
> Estimated time: 2–3 hours focused. Complete Build 6 and read the [lesson](lesson.md) first.
>
...
Then configure Tailwind exactly as in Build 3 (Step 3).
...
It's a search-and-filter page with this layout:
...
[Build 8 — Knowledge Graph 101](../build-8-knowledge-graph/) — the Tier-4 surface. Typed entity navigation that no competitor ships. You'll wire the Graph agent's output from Build 6 into a navigable graph viewer.
