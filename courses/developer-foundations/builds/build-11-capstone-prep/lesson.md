...
The capstone itself is documented in [`../build-12-capstone/`](../build-12-capstone/). This Build is the *preparation* for it.
...
[Build 12 — The Capstone](../build-12-capstone/). Pick your variant: [Atlas Operations](../build-12-capstone/atlas-operations/) or [Aurora Concierge](../build-12-capstone/aurora-concierge/). Eight weeks of focused vibe-coding (or 4 at 2 FTE). Final review-board defence at the end. Cert awarded on pass.
