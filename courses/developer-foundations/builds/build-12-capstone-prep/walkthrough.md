...
- [Atlas Operations](../build-13-capstone/atlas-operations/README.md) — Enterprise / Operations buyer (CTO/CIO).
- [Aurora Concierge](../build-13-capstone/aurora-concierge/README.md) — CX / Digital buyer (CMO/Head of Digital).
...
[Build 13 — The Capstone](../build-13-capstone/). Pick your variant and start building. This is what the whole course was for.
